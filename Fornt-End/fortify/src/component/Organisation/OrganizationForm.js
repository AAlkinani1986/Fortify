...
import useStarRating from './useStar'
export default function OrganizationForm(props) {
  const { InsertOrganization, emailPasswordSignup } = useContext(UserContext)
        ...
        <Form>
          <Form.Group className="mb-3 formDetails" controlId="details">
            <Image
              id="imagePreview"
              thumbnail
              src={require('./data/images/avatar.jpg')}
              style={{
                width: '150px',
                height: '150px',
              }}
          ...
          <Form.Group controlId="formFileSm" className="mb-3">
            <Form.Label className="detailFileUpload">
              Please upload your organization image
            </Form.Label>
            <Form.Control
              type="file"
              size="sm"
